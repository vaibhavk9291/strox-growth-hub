...
class AnimationController {
    ...
    public render() {
        ...
        ctx.fillStyle = '#0F0F0A' // Match site background
        ctx.fillRect(0, 0, this.size, this.size)
        
        ctx.save()
        ctx.translate(this.canvas.width / this.dpr / 2, this.canvas.height / this.dpr / 2)
...
export function SpiralAnimation() {
    ...
    useEffect(() => {
        ...
        // Use exact screen dimensions to prevent aspect ratio stretching
        ...
        // Pass the actual dimensions instead of a square size
    ...
    return (
        <div className="relative w-full h-full bg-[#0F0F0A]">
            <canvas
                ref={canvasRef}
